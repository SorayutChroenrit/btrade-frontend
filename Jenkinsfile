            ...
            steps {
                dir('btrader-backend') {
                    script {
                        ...
                        sh "/usr/local/bin/docker run -d --name btradebackend-run -p 20000:20000 --network host -e  MONGODB_URI='mongodb://sorayutchroenrit:xTuSgmcwPhsGHotw@bondtraderdb.i6rc0pn.mongodb.net:27017/BONDTRADER_DB' btradebackend:latest"
