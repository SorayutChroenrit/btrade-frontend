        ...
        stage('Build') {
            steps {
                script {
                    ...
                    sh "/usr/local/bin/docker run -d --name btradefrontend-run -p 3000:20000 -e MONGODB_URI='mongodb+srv://sorayutchroenrit:ZUwGGkFh0ikC9CWx@bondtraderdb.i6rc0pn.mongodb.net/BONDTRADER_DB' btradefrontend:latest"
